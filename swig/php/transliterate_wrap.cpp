...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(transliterate_globals_id, zend_transliterate_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(transliterate_globals_id, zend_transliterate_globals *, error_code )
#else
#define SWIG_ErrorMsg() (transliterate_globals.error_msg)
#define SWIG_ErrorCode() (transliterate_globals.error_code)
#endif
...
static void transliterate_init_globals(zend_transliterate_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void transliterate_destroy_globals(zend_transliterate_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_transliterate_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_transliterate_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "transliterate"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
zend_module_entry* SWIG_module_entry = &transliterate_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &transliterate_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(transliterate)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(transliterate, transliterate_init_globals, transliterate_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(transliterate_globals_id);
#endif
    return SUCCESS;
}
